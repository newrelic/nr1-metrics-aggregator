				...
				>
					...
					{advancedMode ? (
						...
						<React.Fragment>
							...
							<div className="section-description">
								Select which event type you'd like to aggegate
								(eg. 'PageView')
							</div>
							<EventSelector
								selectedAccountID={selectedAccountID}
							...
							<div className="section-description">
								This tells us what calculation to use when we
								aggregate the data. Do you want to produce a
								uniqueCount, average, etc.
							</div>
							<AggregatorSelector
							...
							<div className="section-description">
								...
								aggregate, it must have a numerical value (eg.
								'Duration')
							</div>
							...
							<div className="section-description">
								You can narrow the scope of this metric to only
								include data that matches on certain key values.
								(eg. appName is "myApp"). Click the filter icon
								down to include more complex filters.
							</div>
							...
							>
								Select additional attributes to keep on the
								metric{" "}
								<span className="attributeMax">
									Max 20 attributes
								</span>
							</div>

							<div className="section-description">
								You can select additional addtributes to keep on
								the metric for further analysis.
							</div>
