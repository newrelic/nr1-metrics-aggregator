...
class MetricNameValidator extends React.Component {
  ...
  setMetricName(userInputtedMetricName) {
    ...
    const metricName = userInputtedMetricName.replace(/[^a-zA-Z0-9\.]/g, ''); // eslint-disable-line no-useless-escape
  ...
  render() {
    ...
    const modifiedMetricName = metricName
      ? ''
      : metricName.replace(/[^a-zA-Z0-9\.]/g, ''); // eslint-disable-line no-useless-escape
